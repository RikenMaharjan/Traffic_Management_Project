...
void receiveEvent()
{
     ...
     alert3=0;
      ...
      while(Wire.available())
      {
          ...
          if (c == x)               //x=1 , activate flag 1 for lane 1 of slave
           ...
           else if (c == p)         //p=1 , alert 1 for lane 1 of slave4
           {
              
              alert1 = 1 ;   
           }
           else if( c == q)         //q=2 , alert 2 for lane 2 of slave4
           {
    ...
    if(alert_tot !=0)
    {
        ...
        if(alert1 != 0)Serial.println("prioritized vehile may arrive in approx 15 sec from lane 1 of junction 4");
        if(alert2 != 0)Serial.println("prioritized vehile may arrive in approx 15 sec from lane 2 of junction 4");
        if(alert3 != 0)Serial.println("prioritized vehile may arrive in approx 15 sec from lane 3 of junction 4");
     }
     Serial.println();
     delay(5);
    Serial.flush();
