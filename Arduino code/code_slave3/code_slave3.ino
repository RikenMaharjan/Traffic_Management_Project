...
void receiveEvent()
{
    ...
    if(alert_tot !=0)
    {
        ...
        if(alert1 != 0)Serial.println("prioritized vehile may arrive in approx 15 sec from lane 1 of junction 3");
        if(alert2 != 0)Serial.println("prioritized vehile may arrive in approx 15 sec from lane 2 of junction 3");
        if(alert3 != 0)Serial.println("prioritized vehile may arrive in approx 15 sec from lane 3 of junction 3");
     }
     Serial.println();
     delay(5);
    Serial.flush();
